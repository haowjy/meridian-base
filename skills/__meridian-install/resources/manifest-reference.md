...
For example, if `__meridian-orchestrator` declares `skills: [/__meridian-spawn, /__meridian-work-coordination]`, installing just the agent will auto-install both skills.
...
# Skill deps (/__meridian-spawn, /__meridian-work-coordination) are
...
skills = ["__meridian-spawn", "__meridian-work-coordination", "__meridian-install"]
